...
public class VisitEntry {
    ...
    /**
     * Loads a raw JSON at R.raw.products and converts it into a list of VisitEntry objects
     */
    public static List<VisitEntry> initProductEntryList(Resources resources) {
        ...
        Gson gson = new Gson();
        Type productListType = new TypeToken<ArrayList<VisitEntry>>() {
        }.getType();
